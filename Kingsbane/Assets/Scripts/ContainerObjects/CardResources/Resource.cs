...
<b>Ongoing Effect:</b>When a player's Mana reaches 0, they can still spend it, however this will cause their Mana to Overload. For each point they are Overloaded by, they have a negative <b>Empowered</b> score equal to their Overload value and all their minions (but not their hero) have -1 Attack, -1 Health for each point Overloaded (to a minimum of 1 Attack, 1 Health). Their Overload value will persist into the next scenario and disappear at the end of that scenario." },
