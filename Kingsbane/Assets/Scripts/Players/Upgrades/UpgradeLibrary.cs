...
public class UpgradeLibrary
{
    ...
    public void InitUpgradeList()
    {
        ...
        var upgrade58 = new UpgradeData()
        {
            ...
            Text = @"At the end of each of your turns, if your hero has not attacked, give them <b>Stealth</b>",
            LoreText = @"",
            HonourPoints = 2,
            IsRepeatable = false,
            NPCLocked = false,
        ...
        var upgrade77 = new UpgradeData()
        {
            ...
            Text = @"Whenever you <b>Divinate,</b> your hero gains <b>Protected</b> equal to the <b>Divinate</b> value",
            LoreText = @"",
            HonourPoints = 3,
            IsRepeatable = false,
            NPCLocked = false,
        ...
        var upgrade78 = new UpgradeData()
        {
            ...
            Text = @"Whenever you <b>Divinate,</b> all friendly units gain <b>Protected</b> equal to the <b>Divinate</b> value, and your hero gains double. This replaces Moonlit Vial",
        ...
        var upgrade87 = new UpgradeData()
        {
            ...
            Text = @"After you cast a spell for the first time on a turn, the caster gains <b>Protected</b> equal to the total cost of the spell. This replaces Mana Shield",
            LoreText = @"",
            HonourPoints = 4,
            IsRepeatable = false,
            NPCLocked = false,
