...
Tiles adjacent to this unit are part of your deployment zone. The first time each turn you play a unit in these tiles, grant it either <b>Prepared</b> or <b>Protected (4)</b>",
        ...
        ClassDeckList = new Dictionary<Classes.ClassList, List<DeckData>>();
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 16,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Abyssal,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card67
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 17,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Agent,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                    }
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 18,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Arcanist,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card37
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 19,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Captain,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card250
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 20,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Elementalist,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card91
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 21,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Grovewatcher,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card111
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 22,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Lifebringer,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card156
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 23,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Lorekeeper,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card179
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 24,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Luminist,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                    }
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 25,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Mercenary,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                    }
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 26,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Oathknight,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card204
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 27,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Runeblade,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card4
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 28,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Trickster,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                        card231
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 29,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Waystalker,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                    }
        ...
        ClassDeckList.Add(
            ...
            new List<DeckData>()
            {
                new DeckData()
                {
                    Id = 30,
                    Name = "Empty Deck",
                    DeckClass = Classes.ClassList.Wildkin,
                    IsNPCDeck = false,
                    CardList = new List<CardData>()
                    {
                    }
