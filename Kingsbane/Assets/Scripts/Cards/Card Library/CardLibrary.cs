...
Deal <b>Piercing</b> damage to your hero equal to half their remaining health",
        ...
        var card90 = new SpellData()
        {
            ...
            Text = @"Choose a tile in range. Deal 3 damage to all units in a line between the target tile and the caster",
            LoreText = @"",
            Notes = @"",
...
<b>Deployment:</b> Add all four of the basic Elemental Spells to your hand.",
        ...
        var card106 = new SpellData()
        {
            ...
            Text = @"Choose a tile in range. Deal 2 damage, <b>Root</b> and push back 3 tiles all units in a line from the target to the caster, as well as all adjacent tiles except for the caster's.
...
At the end of each of your turns, draw a card",
        ...
        var card115 = new UnitData()
        {
            ...
            Resources = new List<Resource>() { new Resource(CardResources.Devotion, 2), new Resource(CardResources.Wild, 2), },
...
Deployment:</b> Deploy a copy of this unit adjacent to it",
        ...
        var card1368 = new UnitData()
        {
            ...
            Text = @"<b>Stalker</b>
Other friendly beasts in range 2 have +1 Attack. Whenever another friendly beast in range kills an enemy, increase this extra attack by 1",
            LoreText = @"",
            Notes = @"",
...
Whenever this unit takes damage from friendly Fire units or spells, they are healed for the same amount instead.",
        ...
        card133.RelatedCards = new List<CardData> { card134 };
